-- 00_invariants_editor.sql
-- Smoke test for Supabase SQL Editor (no RAISE NOTICE — results as rows).
-- Paste into SQL Editor and run. DB is left unchanged (cleanup at end).
...
-- Grab any existing auth.users id to satisfy FK (Supabase always has at least
-- the service_role internal user, but we need a real one). Create a throwaway
-- auth user for the test.
...
-- ============================================================
-- TEST (a): PUBLIC_BID + stage QUOTING -> REJECTED by stage CHECK
-- ============================================================
DO $$
BEGIN
...
-- ============================================================
-- TEST (b): GC_CHASE + LOST + lost_reason NULL -> REJECTED
-- ============================================================
DO $$
BEGIN
...
-- ============================================================
-- TEST (c): FACILITY + NURTURE + revisit_date NULL -> REJECTED
-- ============================================================
DO $$
BEGIN
...
-- ============================================================
-- TEST (d): bids row for FACILITY opp -> REJECTED by guard trigger
-- ============================================================
DO $$
DECLARE
  v_opp_id uuid;
...
-- ============================================================
-- TEST (e): facility_details for PUBLIC_BID opp -> REJECTED by guard trigger
-- ============================================================
DO $$
DECLARE
  v_opp_id uuid;
...
-- ============================================================
-- TEST (f): valid PUBLIC_BID opp + bids row -> must SUCCEED
-- ============================================================
DO $$
DECLARE
  v_opp_id uuid;
...
-- ============================================================
-- RESULTS (6 rows in the grid)
-- ============================================================
SELECT * FROM results ORDER BY "case";

-- ============================================================
-- CLEANUP: remove all test data, leave DB unchanged
-- ============================================================
