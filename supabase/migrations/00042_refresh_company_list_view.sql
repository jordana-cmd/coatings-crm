-- 00042_refresh_company_list_view.sql
-- Drop + recreate v_company_list to pick up archived_at + other new columns.
-- CREATE OR REPLACE fails when column order changes, so we drop first.
