...
export type FederalRow = Database["public"]["Tables"]["federal_details"]["Row"];
...
export type OppWithFederal = OppRow & { federal_details: FederalRow };
export type OppForGates = OppWithBids | OppWithFacility | OppWithFederal;
